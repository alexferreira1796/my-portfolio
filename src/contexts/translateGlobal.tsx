...
export const TranslateGlobal = React.createContext<ITranslateGlobal>(
  {} as ITranslateGlobal
);
...
const TranslateProvider = ({ children }) => {
  ...
  React.useEffect(() => {
    setCurrentLocale(
      locales[navigator.language] ? navigator.language : "en-US"
    );
  }, []);
  ...
  return (
    <TranslateGlobal.Provider
      value={{ currentLocale, changeLocale, getTranslate }}
    >
      {children}
    </TranslateGlobal.Provider>
  );
